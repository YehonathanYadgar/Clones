...
source_url: https://geohot.github.io/blog/jekyll/update/2025/07/06/can-tinygrad-win.html
...
1. Make sure your formulation is simple and complete. Fully capture all dimensions of the search space. The optimization goal is simple, run faster.

1. Apply the state of the art in search. Burn compute. Use LLMs to guide. Use SAT solvers. Reinforcement learning. It doesn’t matter, there’s no way to cheat this goal. Just see if it runs faster.
