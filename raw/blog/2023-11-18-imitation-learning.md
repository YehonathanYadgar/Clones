...
source_url: https://geohot.github.io/blog/jekyll/update/2023/11/18/imitation-learning.html
...
1. Train a supervised model `f(S_t) -> A_t`

1. Drive cars with that model.
