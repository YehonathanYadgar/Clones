...
source_url: https://geohot.github.io/blog/jekyll/update/2024/10/28/americas-future.html
...
In **Europe**, [GDP per capita](https://data.worldbank.org/indicator/NY.GDP.PCAP.CD?locations=FR-GB-DE) has been stagnant since 2008. These countries started out at a very high point, so standards are living are still high and they can coast off of past economic success. Anecdotally, nobody starts a new company in Europe and the most ambitious leave, so there won’t be growth from that any time soon.
...
![image](https://geohot.github.io/blog/assets/images/denmark_immigration.png)

Coasting won’t work either. The Airbus [A321](https://en.wikipedia.org/wiki/Airbus_A321) will be outcompeted by the Comac [C919](https://en.wikipedia.org/wiki/Comac_C919). The Chinese will work harder for less money and accept a lower profit margin, the planes will cost half as much, and the world will switch.
...
In **Russia**, the oligarchs seized power when the Soviet Union collapsed. Privatizing the state meant all those with connections got to grab the old wealth of the state. While the electricity in Russia still works (because the oligarchs are competent), [GDP per capita](https://data.worldbank.org/indicator/NY.GDP.PCAP.CD?locations=RU) has also been stagnant since 2008.

You see some aspects of this in America already. The state is mostly just a cow to milk for money by large corporations and friends of the state. Read the [Infrastructure Investment and Jobs Act](https://www.congress.gov/bill/117th-congress/house-bill/3684/text), [CHIPS and Science Act](https://www.congress.gov/bill/117th-congress/house-bill/4346/text), and the ironically named [Inflation Reduction Act](https://www.congress.gov/bill/117th-congress/house-bill/5376/text) and it’s hard to see them as anything besides the oligarchs looting the state and giving the money to their friends.

**South Africa** is the worst of the 3, with a notable drop in [GDP per capita](https://data.worldbank.org/indicator/NY.GDP.PCAP.CD?locations=ZA) since 2011.

When you have [popular songs like this](https://en.wikipedia.org/wiki/Dubul%27_ibhunu), it’s not hard to see what’s happened in the country. People often think Detroit became hell because the car industry left for right to work states, but it was actually two race riots in [1943](https://en.wikipedia.org/wiki/1943_Detroit_race_riot) and [1967](https://en.wikipedia.org/wiki/1967_Detroit_riot). After the second one, people had had it, and those with the means left. The people with means are generally also the people capable of producing value.
...
**America** is still the king of the technology industry. All of the programming languages and operating systems come from America. But this is not because Americans are particularly good at software, it’s [because of immigration](https://lwn.net/Articles/404729/) and a merit based society. Historically, America has gotten the best software engineers from Europe, India, and China.

![image](https://geohot.github.io/blog/assets/images/market_caps.png)
...
Part of the safety issue may just be California, and I’ll be [moving elsewhere](https://en.wikipedia.org/wiki/California_exodus) next year regardless. I have absolutely had it with the crime, it isn’t a society and it’s so sad to see. California has really screwed themselves, and I think a lot of people are at their breaking point.

![image](https://geohot.github.io/blog/assets/images/ca_elon_tweet.jpg)
