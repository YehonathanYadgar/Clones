---
title: 'AI will create jobs'
date: 2026-05-01
slug: ai-will-create-jobs
source_url: https://geohot.github.io/blog/jekyll/update/2026/05/01/ai-will-create-jobs.html
author: George Hotz (geohot)
---

# AI will create jobs

It’s nice to see [Jensen talk about this](https://x.com/firstadopter/status/2050225746753331562), and it’s super obvious when you think about it.
...
Wants are effectively unlimited. It’s classic [Jevons paradox](https://en.wikipedia.org/wiki/Jevons_paradox) that if we make something more efficient, we end up using more of it. Or a cool aphorism I learned at Facebook, if you make the site 10% faster, people spend 5% more *total* time on it.
