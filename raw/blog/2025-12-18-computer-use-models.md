...
source_url: https://geohot.github.io/blog/jekyll/update/2025/12/18/computer-use-models.html
...
I see people on Twitter saying I’m late to these things. Opus 4.5 [was released Nov 24](https://www.anthropic.com/news/claude-opus-4-5), less than a month ago, and similar to how I felt ChatGPT o1 was the [first model that could program at all](https://www.reddit.com/r/singularity/comments/1fh7tjv/geohotz_endorses_gpto1_coding/), Opus 4.5 is the first model I feel that can use computers at all. There’s [evidence for that being true](https://metr.org/blog/2025-03-19-measuring-ai-ability-to-complete-long-tasks/), as well as trying the other models (even GPT 5.2) in agentic loops and they aren’t good. Both Claude Code and [opencode](https://opencode.ai/) behave similarly with Opus 4.5, and opencode or [Claude Code with other models](https://github.com/musistudio/claude-code-router) performs poorly.
