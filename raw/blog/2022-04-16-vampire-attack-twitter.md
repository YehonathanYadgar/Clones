...
source_url: https://geohot.github.io/blog/jekyll/update/2022/04/16/vampire-attack-twitter.html
...
For reference, this is a [vampire attack](https://finematics.com/vampire-attack-sushiswap-explained/), perhaps best popularized by SushiSwap.
...
Step 4: Also reward likers and retweeters, assuming they link their Twitter account and use the TWITCHAIN front end to take the action. Even lurkers will use TWITCHAIN front end because it doesn’t have ads and fake “trending” topics. It’s like [nitter](https://nitter.net), but responsive because you didn’t cheap out on the cloud bill and with FREE MONEY!
...
Responding to the [HN doubters](https://news.ycombinator.com/item?id=31060368): With TLS verification captured by the extension it’s easy to confirm that any scraped data is authentic. And Twitter does a lot already to prevent Sybil attacks, you also wouldn’t reward any accounts created after TWITCHAIN. While it’s easy to game many crypto things like this, I believe this is different since we are bootstrapping using Twitter.
